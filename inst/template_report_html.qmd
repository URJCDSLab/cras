...
boxes_loss <- lapply(myvbs(values = c(.avg_loss),
                           icons = c("arrow-up", "arrow-down"),
                           titles = c("Average current loss magnitude",
                                      "Average proposed loss magnitude")),
                     as.character)

knitr::raw_html(paste(unlist(boxes_loss), collapse = "\n"))
```
...
#| out-width: "100%"
p <- cras::plot_densities(data, loss_type = "magnitude", show_title = FALSE) +
...
#| out-width: "100%"
p <- cras::plot_chance(data, loss_type = "magnitude", show_title = FALSE) +
  scale_color_manual(values = c("#fab117", "#5cae6e")) +
  scale_fill_manual(values = c("#fab117", "#5cae6e")) + 
  theme(legend.position = "none")
ggplotly(p)
...
boxes_events <- lapply(myvbs(values = .avg_events,
                             icons = c("arrow-up", "arrow-down"),
                             titles = c("Average current loss events",
                                        "Average proposed loss events")),
                       as.character)

knitr::raw_html(paste(unlist(boxes_events), collapse = "\n"))
```
...
#| out-width: "100%"
p <- cras::plot_densities(data, loss_type = "events", show_title = FALSE) +
  scale_color_manual(values = c("#fab117", "#5cae6e")) +
  scale_fill_manual(values = c("#fab117", "#5cae6e")) + 
  theme(legend.position = "none")
ggplotly(p)
...
#| out-width: "100%"
p <- cras::plot_chance(data, loss_type = "events", show_title = FALSE) +
  scale_color_manual(values = c("#fab117", "#5cae6e")) +
  scale_fill_manual(values = c("#fab117", "#5cae6e")) + 
  theme(legend.position = "none")
ggplotly(p)
